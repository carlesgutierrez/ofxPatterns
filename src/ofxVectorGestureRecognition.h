...
#ifndef OF_VECTORGESTURERECOGNITION
#define OF_VECTORGESTURERECOGNITION

#include "ofxPatternRecognition.h"

class VectorGestureRecognitionConfiguration;

typedef ofPatternRecognition<std::vector<double>, VectorGestureRecognitionConfiguration> ofVectorGestureRecognition;
