...
#ifndef OF_SPEECHCLASSIFICATION
#define OF_SPEECHCLASSIFICATION

#include "ofxPatternClassification.h"

class SpeechClassificationConfiguration;

typedef ofPatternClassification< float, SpeechClassificationConfiguration > ofSpeechClassification;
